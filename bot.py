...
async def show_products_br(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if response.get('status') == 200:
        ...
        normal_diamonds = [86, 172, 257, 343, 429, 514, 600, 706, 878, 963, 1049, 1135, 1220, 1412, 1584, 1669, 2195, 2538, 2901, 3158, 3688, 4394, 5100, 5532, 6055, 6752, 7030, 7727, 9288]
...
DIAMOND_SPLITS = {
    ...
    5100: [2195, 2195, 706],
    6055: [3688, 2195, 172],
    6752: [5532, 706, 257, 257],
    7030: [5532, 706, 706, 86],
    7727: [5532, 2195],
...
SESSION_COOKIE = "mft9orbmve1q2k5aep8p86cug7"  # Change this to your session cookie
